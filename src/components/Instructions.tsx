  ...
  return (
    <div className="space-y-8 max-w-4xl">
      ...
      <div className="bg-[#18181b] border border-[#27272a] rounded-xl p-6 md:p-8 space-y-4">
        ...
        <div className="flex items-center gap-2 text-xs text-[#fafafa] bg-[#09090b]/50 py-2.5 px-3 rounded-lg border border-[#27272a] max-w-md">
        ...
        <div className="pt-2">
          <button
            ...
            className="px-4 py-2 bg-white hover:bg-zinc-200 text-black font-semibold rounded-md text-xs transition cursor-pointer"
          >
            Mulai Unggah Excel
          </button>
        </div>
