...
export type ActiveTab = 'upload' | 'table' | 'sc-buang-dana' | 'wd-pending' | 'order-summary' | 'template-builder' | 'instructions' | 'qris-crosscheck' | 'naik-saldo-qris' | 'peminjaman-dana' | 'croscek-turnover';
